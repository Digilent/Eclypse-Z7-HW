...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
digilentinc.com:hls:StreamDecimate:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: StreamDecimate_0, and set properties
  set StreamDecimate_0 [ create_bd_cell -type ip -vlnv digilentinc.com:hls:StreamDecimate:1.0 StreamDecimate_0 ]
  ...
  set_property -dict [ list \
   CONFIG.kADC_ClkDiv {2} \
   CONFIG.kADC_Width {14} \
   CONFIG.kCh1CouplingStatic {"1"} \
   CONFIG.kCh1GainStatic {"1"} \
   CONFIG.kCh1HgAddCoefStatic {"111111111000010000"} \
   CONFIG.kCh1HgMultCoefStatic {"010001011000110001"} \
   CONFIG.kCh1LgAddCoefStatic {"111111111000101101"} \
   CONFIG.kCh1LgMultCoefStatic {"010000101000010100"} \
   CONFIG.kCh2CouplingStatic {"1"} \
   CONFIG.kCh2GainStatic {"1"} \
   CONFIG.kCh2HgAddCoefStatic {"000000000111110100"} \
   CONFIG.kCh2HgMultCoefStatic {"010001011110001100"} \
   CONFIG.kCh2LgAddCoefStatic {"000000000000010000"} \
   CONFIG.kCh2LgMultCoefStatic {"010000101100010100"} \
   CONFIG.kExtCalibEn {true} \
   CONFIG.kExtCmdInterfaceEn {false} \
   CONFIG.kExtRelayConfigEn {true} \
   CONFIG.kExtSyncEn {false} \
   CONFIG.kSamplingPeriod {9524} \
   CONFIG.kZmodID {0} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_JITTER {124.884} \
   CONFIG.CLKOUT2_PHASE_ERROR {94.994} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {105} \
   CONFIG.CLKOUT2_REQUESTED_PHASE {0} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {109.776} \
   CONFIG.CLKOUT3_PHASE_ERROR {94.994} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {210} \
   CONFIG.CLKOUT3_REQUESTED_PHASE {0.000} \
   CONFIG.CLKOUT3_USED {true} \
   CONFIG.CLKOUT4_JITTER {145.943} \
...
0#Enet 0}\
   ...
   CONFIG.PCW_QSPI_PERIPHERAL_FREQMHZ {128} \
  ...
  connect_bd_intf_net -intf_net ZmodADC_Controller_0_DataStream [get_bd_intf_pins StreamDecimate_0/axisStreamIn] [get_bd_intf_pins ZmodADC_Controller_0/DataStream]
  connect_bd_intf_net -intf_net ZmodScopeAXIConfigur_0_ExtCh1Calib [get_bd_intf_pins ZmodADC_Controller_0/ExtCh1Calib] [get_bd_intf_pins ZmodScopeAXIConfigur_0/ExtCh1Calib]
  connect_bd_intf_net -intf_net ZmodScopeAXIConfigur_0_ExtCh2Calib [get_bd_intf_pins ZmodADC_Controller_0/ExtCh2Calib] [get_bd_intf_pins ZmodScopeAXIConfigur_0/ExtCh2Calib]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins StreamDecimate_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ZmodScopeAXIConfigur_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net ZmodADC_Controller_0_sConfigError [get_bd_pins ZmodADC_Controller_0/sConfigError] [get_bd_pins ZmodScopeAXIConfigur_0/sConfigError]
  connect_bd_net -net ZmodADC_Controller_0_sDataOverflow [get_bd_pins ZmodADC_Controller_0/sDataOverflow] [get_bd_pins ZmodScopeAXIConfigur_0/sDataOverflow]
  connect_bd_net -net ZmodADC_Controller_0_sInitDoneADC [get_bd_pins ZmodADC_Controller_0/sInitDoneADC] [get_bd_pins ZmodScopeAXIConfigur_0/sInitDoneADC]
  connect_bd_net -net ZmodADC_Controller_0_sInitDoneRelay [get_bd_pins ZmodADC_Controller_0/sInitDoneRelay] [get_bd_pins ZmodScopeAXIConfigur_0/sInitDoneRelay]
  connect_bd_net -net ZmodADC_Controller_0_sRstBusy [get_bd_pins ZmodADC_Controller_0/sRstBusy] [get_bd_pins ZmodScopeAXIConfigur_0/sRstBusy]
  ...
  connect_bd_net -net ZmodScopeAXIConfigur_0_lReset_n [get_bd_pins ZmodADC_Controller_0/aRst_n] [get_bd_pins ZmodScopeAXIConfigur_0/lReset_n]
  connect_bd_net -net ZmodScopeAXIConfigur_0_sCh1Coupling [get_bd_pins ZmodADC_Controller_0/sCh1CouplingConfig] [get_bd_pins ZmodScopeAXIConfigur_0/sCh1CouplingConfig]
  connect_bd_net -net ZmodScopeAXIConfigur_0_sCh1Gain [get_bd_pins ZmodADC_Controller_0/sCh1GainConfig] [get_bd_pins ZmodScopeAXIConfigur_0/sCh1GainConfig]
  connect_bd_net -net ZmodScopeAXIConfigur_0_sCh2Coupling [get_bd_pins ZmodADC_Controller_0/sCh2CouplingConfig] [get_bd_pins ZmodScopeAXIConfigur_0/sCh2CouplingConfig]
  connect_bd_net -net ZmodScopeAXIConfigur_0_sCh2Gain [get_bd_pins ZmodADC_Controller_0/sCh2GainConfig] [get_bd_pins ZmodScopeAXIConfigur_0/sCh2GainConfig]
  connect_bd_net -net ZmodScopeAXIConfigur_0_sTestMode [get_bd_pins ZmodADC_Controller_0/sTestMode] [get_bd_pins ZmodScopeAXIConfigur_0/sTestMode]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins ZmodADC_Controller_0/SysClk100] [get_bd_pins ZmodScopeAXIConfigur_0/SysClk100] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins StreamDecimate_0/ap_clk] [get_bd_pins ZmodADC_Controller_0/ADC_SamplingClk] [get_bd_pins ZmodScopeAXIConfigur_0/ADC_SamplingClk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins rst_clk_wiz_0_axi_stream/slowest_sync_clk]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs StreamDecimate_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ZmodScopeAXIConfigur_0/s_axi_control/reg0] -force
