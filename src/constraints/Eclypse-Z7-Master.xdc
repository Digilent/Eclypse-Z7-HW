...
# RGB LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { rgbled[0] }]; #IO_L9N_T1_DQS_AD3N Sch=led0_b
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { rgbled[1] }]; #IO_L8P_T1_AD10P Sch=led0_g
set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33 } [get_ports { rgbled[2] }]; #IO_L8N_T1_AD10N Sch=led0_r
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { rgbled[3] }]; #IO_L9P_T1_DQS_AD3P Sch=led1_b
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { rgbled[4] }]; #IO_L10P_T1_AD11P Sch=led1_g
set_property -dict { PACKAGE_PIN A19   IOSTANDARD LVCMOS33 } [get_ports { rgbled[5] }]; #IO_L10N_T1_AD11N Sch=led1_r
